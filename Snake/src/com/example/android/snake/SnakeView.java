...
public class SnakeView extends TileView implements OnClickListener {
	 ...
	 */
	private int mDirection = NORTH; // �ߵ����ַ������һ��ǰ���ķ���
	 ...
	 */
	private static final int RED_STAR = 1;// ��������ǩ�ֱ�����ʾ��ͬ��tile��drawable������RED_STAR��������ߵ����ӵĵ㣨tile��
	 ...
	 * captured.
	 */
	private long mScore = 0; // �ɼ������˶��ٵ�ƻ��
	private long mMoveDelay = 600;// ������ٺ�������ƶ�һ��
	/**
	 ...
	 */
	private long mLastMove; // ��һ���ƶ���ʱ��

	/**
	 * mStatusText: text shows to the user in some run states
	 */
	private TextView mStatusText;// ����ǿ�ʼ��ʱ�����ʾ��

	/**
	 * mSnakeTrail: a list of Coordinates that make up the snake's body
	 * mAppleList: the secret location of the juicy apples the snake craves.
	 */
	private ArrayList<Coordinate> mSnakeTrail = new ArrayList<Coordinate>();// �ߵ����У��㣩tile����������
	private ArrayList<Coordinate> mAppleList = new ArrayList<Coordinate>();// ƻ�������У��㣩tile����������
	...
	// �ص�˵����߰ɡ���ʵ������������ĵط�����������˵�ġ����������ˡ����ˢ�µ�handler�������������Handler��ͯЬ��ǿ�ҽ����Դ�롣��
	// ͨ�����Handler���Լ�������Ϣ�������ӳ�30����Լ���һ����Ϣ��������ʵ����һ��ѭ�����ܴ������뷨��

	private Button mStart; // ����������ť�ֱ����Ҽӵġ���Ϊԭ����ֻ����Ӧ�������Ҽ��Ĳ�������������㴥���Ĳ���Ч���������ڲ����ļ��п���صĲ��֡�
	...
	// ����������������ĵط��ˡ�������sleep��Ȼ���ӳ�delayMillis��֮�󣬷����Լ�һ����Ϣ��Ȼ�������Ϣ��handleMessage�б������ˡ�
	// ����Ĺ��̣�������update������update�����ֵ�����sleep����������һ��������ѭ���Ϳ�ʼ�ˡ�
	 ...
	 *         [x1,y1,x2,y2,x3,y3...] ����һ�����������ת����һά����ĺ���������һ���������෴�ġ�
	 */
	 ...
	 *            ������Ϸ�����ݡ�������Ϸ�С�����home�г�ȥ�ˡ������Ϳ��Ա�����Ϸ�����ݡ��л���ʱ���ܼ�����
	 */
	 ...
	 * we want to grow him, we don't subtract from the rear. �����ߡ���ʵ���ǲ������ƶ���Ч����
	 */
